# Archive discourse.wicg.io

## Heavily based on https://github.com/mcmcclur/ArchiveDiscourse/tree/master
...
# When archiving larger sites (like wicg.discourse.org), you might need to 
...
#            avatar_url = base_scheme + '://' + avatar_url
    ...
    post_string = post_string + '          <div class="creation_date">' + creation_date + '</div>\n'
...
def topic_row(topic_json):
    ...
    topic_html = topic_html + '        <span class="post-creation-date">'
    topic_html = topic_html + str(topic_post_creation_date) + '</span>\n'
